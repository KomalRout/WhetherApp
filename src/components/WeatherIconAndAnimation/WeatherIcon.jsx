...
const WeatherIcon = ({ code }) => {
  switch (code) {
    ...
    case 57:
      return (
        <img alt="Drizzle" src="public/assets/images/icon-drizzle.webp" />
      );
    case 61:
    case 63:
    case 65:
    ...
    case 67:
      return (
        <img alt="Rainy" src="public/assets/images/icon-rain.webp" />
      );
    case 71:
    case 73:
    case 75:
    ...
    case 86:
      return (
        <img alt="Snowy" src="public/assets/images/icon-snow.webp" />
      );
    case 80:
    case 81:
    case 82:
      return (
        <img
          alt="Partly cloudy"
          src="public/assets/images/icon-rain.webp"
        />
      );
    case 95:
    case 96:
